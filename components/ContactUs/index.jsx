        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
            <div class="text-center px-6">
                ...
                <div class="content mt-7">
                    ...
                    <p class="text-slate-400 mt-3">Contact us via our phoen line open 8:am - 5:pm monday - saturday</p>
                    
                    <div class="mt-5">
                        <a href="tel:+2349012703920" class="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">+234-901-2703-920</a>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center px-6">
                ...
                <div class="content mt-7">
                    ...
                    <p class="text-slate-400 mt-3">send us an Email us today</p>
                    
                    <div class="mt-5">
                        <a href="mailto:junabrealty@gmail.com" class="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">junabrealty@gmail.com</a>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center px-6">
                ...
                <div class="content mt-7">
                    ...
                    <p class="text-slate-400 mt-3">Abuja, <br /> Nigeria</p>
