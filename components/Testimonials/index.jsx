                  ...
                  >
                    ...
                    >
                      <div className="text-center mx-3">
                        <p className="text-lg text-slate-400 italic">
                          ...
                          increased the amount of interest and ultimately saved
                          us over $10,000. "{" "}
                        </p>
                    ...
                    >
                      <div className="text-center mx-3">
                        <p className="text-lg text-slate-400 italic">
                          {" "}
                          " I highly recommend Hously as the new way to sell
                          your home "by owner". My home sold in 24 hours for the
                          asking price. Best $400 you could spend to sell your
                          home. "{" "}
                        </p>
                    ...
                    >
                      <div className="text-center mx-3">
                        <p className="text-lg text-slate-400 italic">
                          {" "}
                          " My favorite part about selling my home myself was
                          that we got to meet and get to know the people
                          personally. This made it so much more enjoyable! "{" "}
                        </p>
                    ...
                    >
                      <div className="text-center mx-3">
                        <p className="text-lg text-slate-400 italic">
                          {" "}
                          " Great experience all around! Easy to use and
                          efficient. "{" "}
                        </p>
                    ...
                    >
                      <div className="text-center mx-3">
                        <p className="text-lg text-slate-400 italic">
                          {" "}
                          " Hously made selling my home easy and stress free.
                    ...
                    >
                      <div className="text-center mx-3">
                        <p className="text-lg text-slate-400 italic">
                          {" "}
                          " Hously is fair priced, quick to respond, and easy to
                          use. I highly recommend their services! "{" "}
                        </p>
